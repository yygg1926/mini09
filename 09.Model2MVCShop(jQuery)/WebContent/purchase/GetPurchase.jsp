...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">${purchase.dlvyAddr}</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">${purchase.dlvyRequest}</td>
				</tr>
			</table>
		</td>
	</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						<a href="/updatePurchaseView.do?tranNo=${purchase.tranNo}&prodNo=${purchase.purchaseProd.prodNo}">수정</a>
					</td>
